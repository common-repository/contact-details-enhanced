<div class="wrap">
	...
	<form method="post" action="options.php">
		...
		<table class="form-table">
			...
			<tr valign="top">
				<th>
					<label for="<?php echo $this->tag; ?>[bank]"><?php _e( 'Bank' ); ?></label>
				</th>
				<td>
					<textarea class="regular-text" cols="40" rows="5" id="<?php echo $this->tag; ?>[bank]" name="<?php echo $this->tag; ?>[bank]"><?php if ( array_key_exists( 'bank', $this->options ) ) { esc_html_e( $this->options['bank'] ); } ?></textarea>
				</td>
			</tr>
			<tr valign="top">
				<th>
