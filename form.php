<form id="commentform" class="contactform" method="post" action="">
	...
	<p class="content_name">
		...
		<label for="contact_name">
			<small><?php _e( 'Naam' ); ?> (<?php _e( 'verplicht' ); ?>)</small>
		</label>
	</p>
	<p class="content_email">
		...
		<label for="contact_email">
			<small><?php _e( 'Email' ); ?> (<?php _e( 'verplicht' ); ?>)</small>
		</label>
	</p>
	...
	<p class="content_submit">
		<input type="submit" value="<?php _e( 'Verstuur bericht' ); ?>" tabindex="5" id="submit" name="contact[submit]" />
	</p>
</form>